...
#had jouj flags li home --interactve --ty kay3ni fach anrunniw l commande we will get a running shell within that container
#--rm flag kat3ni once we exit the process of our container , it should actually remove that from our system 
